resource "azurerm_vpn_gateway" "hub1-vpn1" {
  ...
  bgp_settings {
    asn         = var.asn.hub1_vpn1
    peer_weight = 0
    instance_0_bgp_peering_address {
      custom_ips = var.peering_address.hub1_vpn1_i0
    }
    instance_1_bgp_peering_address {
      custom_ips = var.peering_address.hub1_vpn1_i1
    }
...
resource "azurerm_vpn_gateway_connection" "aws1-hub1" {
  ...
  vpn_link {
    ...
    bgp_enabled      = true
    custom_bgp_address {
      ip_address          =  var.peering_address.hub1_vpn1_i0[0]
      ip_configuration_id = "Instance0"
    }
    custom_bgp_address {
      ip_address          =  var.peering_address.hub1_vpn1_i1[0]
  ...
  vpn_link {
    ...
    bgp_enabled      = true
    custom_bgp_address {
      ip_address          =  var.peering_address.hub1_vpn1_i0[1]
      ip_configuration_id = "Instance0"
    }
    custom_bgp_address {
      ip_address          =  var.peering_address.hub1_vpn1_i1[1]
      ip_configuration_id = "Instance1"
    }
    shared_key = var.psk
  }
